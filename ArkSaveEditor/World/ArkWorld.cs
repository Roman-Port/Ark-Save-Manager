...
namespace ArkSaveEditor.World
{
    ...
    public class ArkWorld
    {
        ...
        public List<ArkPlayer> players = new List<ArkPlayer>();

        /// <summary>
        /// Convert the map from a low-level object to a high-level object.
        /// </summary>
        /// <param name="arkFile"></param>
        public ArkWorld(DotArkFile arkFile, ArkMapData overrideMapData = null)
        {
            ...
            for(int i = 0; i<sources.Count; i++)
            {
                ...
                {
                    players.Add(new ArkPlayer(this, this.sources[i]));
